...
<body class="p-3">
  ...
  <form method="post" action="/edit">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="nameInput" name="name" value="{{ $reservation->name }}" required>
    </div>

    <div class="form-group">
      <label for="telInput">Tel</label>
      <input type="text" class="form-control" id="telInput" name="tel" value="{{ $reservation->tel }}" required>
    </div>

    <div class="form-group">
      <label for="mailInput">Mail</label>
      <input type="email" class="form-control" id="mailInput" name="mail" value="{{ $reservation->mail }}" required>
    </div>

    <div class="form-group">
      <label for="dateInput">Reservation Date</label>
      <input type="datetime-local" class="form-control" id="dateInput" name="datetime" value="{{ $reservation->datetime }}" required>
    </div>

    <div class="form-group">
      <label for="etcInput">etc</label>
      <textarea class="form-control" id="etcInput" rows="3" name="etc">{{ $reservation->etc }}</textarea>
    </div>
    <div class="form-group">
